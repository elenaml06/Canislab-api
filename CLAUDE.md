...
| `pruebas_completas.py` | **La batería.** Los 90 bloques, ~40 min. Es lo que se ejecuta entero antes de entregar cualquier cambio (ver «Cómo se prueba») |
...
Los 90 bloques tardan unos **40 minutos** (2.387 s en la última medida; el
