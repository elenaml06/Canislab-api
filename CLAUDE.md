...
6. **NADA VIVE SOLO EN LA APP.** Ninguna lista que la app enseñe puede
   ...
   **por casualidad**, porque una lista copiada a mano no da error: se queda
   ...
   El inventario es `lo_que_la_app_pinta.json`: **14 listas**, cada una con su
