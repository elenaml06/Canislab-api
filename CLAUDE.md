...
2. **Los límites de seguridad crónica** (vitamina D, yodo, selenio,
   ...
   el primero, la vitamina E del perro sano (67,1 mg/1000 kcal). Y ahí vale la
   regla de siempre: **si una fuente contradice a FEDIAF, gana FEDIAF**, así que
   un suelo del libro que se pasara de un máximo de FEDIAF se cae y se dice. En adulto son
