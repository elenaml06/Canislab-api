...
def _seguridad_completa(gramos, al, der, etapa, patologias=None):
    problemas = list(revisar_seguridad_v2(gramos, al, der, etapa, patologias) or [])
...
def endpoint_verificar_semana(datos: PeticionVerificarSemana):
    """⚠️ AÑADIDO (5 agosto, madrugada) — pedido expreso: comprueba el
    aporte de tiaminasa a lo largo de TODA la semana de rotación (todos
    los menús generados juntos, ponderados por sus días), no solo
    dentro de un menú aislado -- ver revisar_seguridad_semanal."""
