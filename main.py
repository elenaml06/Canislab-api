...
SELLOS_DE_LOS_DATOS = {
        ...
        "alimentos_v3_final.json":      "3f08d356aee8b3b8",   # 8 sep: 159 -> 162 fichas. Tres piezas llevaban nombre de TERNERA y datos de VACA (coincidian celda a celda con el registro de vaca de USDA y no con el de ternera): timo, pulmon y cerebro. No se elige una especie y se pierde la otra -- se parten en dos, cada una con SUS datos. La diferencia no es un decimal: el timo de vaca tiene 236 kcal y 20,35 g de grasa, el de ternera 101 y 3,07. Las 99 referencias de catalogo_menus.json se repuntan a las fichas de vaca, que son las que se usaron para calcular esos menus. Incluye ademas todo lo del 7 sep: 52 ceros cerrados contra BEDCA/CIQUAL/USDA en el orden de Bases.md. auditar_catalogo.py y auditar_fediaf.py re-ejecutados, pruebas_completas.py entero.
