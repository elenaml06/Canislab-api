...
def pauta_firmar(datos: PeticionFirmar):
    ...
    documento = {
        ...
        "huecos": {
            ...
            # `trazas` va aquí y NO en `en_cristiano` (3 septiembre): esa
            # lista alimenta la pantalla que dice "no está publicado el
            # valor", y de una traza SÍ está publicado -- la fuente dice
            # «trazas», que es un dato, no un hueco. Pero en el documento
            # firmado consta igual, porque quien lo firma tiene derecho a
            # saber cuáles de los ceros de la ración son medidas y cuáles
            # son "por debajo del límite de cuantificación".
            "trazas": ficha.get("datos_traza") or {},
