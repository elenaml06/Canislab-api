...
SELLOS_DE_LOS_DATOS = {
        ...
        "alimentos_v3_final.json":      "53cfe52084f82a6d",   # 6 sep: nota_datos de los 4 alimentos excluidos por tejido tiroideo (Cuello de pavo/pato/ternera, Laringe de vacuno) documenta el bloqueo -- ver seguridad.TIROIDES_EXCLUIR. Ningun numero nutricional cambia.
...
def verificar():
    ...
    SELLOS_CRUDOS = {
        "der.py": "f51401ece13eed1d",   # 6 sep: 3 correcciones de cita en comentarios (VII-7 no VII-6, Thes 2015 no 2014, y el escalon 210/175/140 no es tabla de FEDIAF) -- ningun numero ni comportamiento cambia.
    }
