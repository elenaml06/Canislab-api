...
- [ ] **Dar veredicto a lo que queda de las dos fuentes, y el número es exacto**: FEDIAF **269** elementos de texto (de 532; el 100 % del documento está ya desglosado) y SACN5 **3.140** (filtro nutricional). Los clavan el BLOQUE 68 y el BLOQUE 81: solo bajan cuando alguien lee y los baja en el mismo commit
